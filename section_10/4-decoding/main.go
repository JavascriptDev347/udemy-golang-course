...
func main() {
	//Encoding  → ma'lumotni format o'zgartirish (JSON, Base64, XML)
	//→ converts data format — NOT for security

	//Encryption → ma'lumotni yashirish, kalit bilan (AES, RSA)
	//→ hides data with a key — FOR securityg
